...
function routeFor(capability = {}) {
  if (capability.domain === "super") {
    return ["select_super_capability", "read_spec", "compose_capabilities", "run_cycle", "teach_next_agent"];
  }
  if (capability.domain === "world") {
    return ["map_external_surface", "prepare_plan", "check_approval", "return_receipt", "verify_no_external_effect"];
  }
