/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/bridge-gateway/wrangler.jsonc apps/bridge-gateway/src/worker-configuration.d.ts` (hash: ada5cb608f0ab39ec5129a4f733fac3c)
...
interface __BaseEnv_Env {
	...
	MISSION_STORE: DurableObjectNamespace<import("./index").MissionStoreDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "MissionStoreDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACTION_DEFAULT_DEVICE_ID" | "ACTION_INSTALLATION_KEY" | "ACTION_WORKSPACE_KEY">> {}
}
