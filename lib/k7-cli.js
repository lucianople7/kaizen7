...
function buildDoctorReport(root = process.cwd()) {
  ...
  const requiredCommands = ["status", "run", "preflight", "loop", "system", "wizard", "mission", "solve", "handoff", "anything", "mesh", "adapt", "radar", "opportunity", "commons", "forge", "trust", "eval", "production", "improve", "recall", "context", "resume", "journal", "remember", "receipt", "check"];
  const checks = [
    {
