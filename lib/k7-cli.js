...
function buildDoctorReport(root = process.cwd()) {
  ...
  const requiredCommands = ["status", "run", "mission", "solve", "handoff", "anything", "mesh", "adapt", "radar", "opportunity", "commons", "trust", "eval", "production", "improve", "recall", "context", "resume", "journal", "remember", "receipt", "check"];
  const checks = [
    {
