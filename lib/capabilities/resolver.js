...
const DOMAIN_HINTS = {
  super: [/super|mega|ecosistema|ecosystem|orquest|orquestar|rapido|eficaz|menos pasos|less steps|siguiente mejor|next best|tarjeta|run card|ejecucion compacta/i],
