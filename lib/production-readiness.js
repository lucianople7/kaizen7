...
function checkProductionReadiness(options = {}) {
  ...
  if (exists(root, "package.json")) {
    ...
    for (const script of ["check", "k7:super", "k7:brain", "k7:agent", "k7:advise", "k7:codex", "k7:real", "k7:adapt", "k7:openai", "k7:run", "k7:hunter", "k7:frontier", "k7:frontier:brief", "k7:github", "k7:hf", "k7:signal"]) {
