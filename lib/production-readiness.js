...
function checkProductionReadiness(options = {}) {
  ...
  if (exists(root, "server.js")) {
    ...
    for (const [id, endpoint] of [["k7-run", "/api/k7/run"], ["k7-advise", "/api/k7/advise"], ["k7-codex", "/api/k7/codex"], ["k7-realize", "/api/k7/realize"], ["k7-connect", "/api/k7/connect"], ["k7-super", "/api/k7/super"], ["k7-brain", "/api/k7/brain"], ["k7-adapters-plan", "/api/k7/adapters/plan"], ["k7-frontier", "/api/k7/frontier"], ["k7-openai-activate", "/api/k7/openai/activate"]]) {
  ...
  if (exists(root, "package.json")) {
    ...
    for (const script of ["check", "k7:init", "k7:super", "k7:brain", "k7:agent", "k7:advise", "k7:codex", "k7:real", "k7:connect", "k7:adapt", "k7:openai", "k7:run", "k7:hunter", "k7:frontier", "k7:frontier:brief", "k7:github", "k7:hf", "k7:signal"]) {
