...
const dictionary = {
  es: {
    ...
    "hero.kicker": "AI-first platform - Research for Human Performance",
    "hero.copy": "Una plataforma premium preparada para visuales, redes, ecommerce futuro y asistente IA, sin ruido ni promesas magicas.",
    "launch.social.title": "Social engine",
    "launch.social.body": "Clips, trailers, newsletter y comunidad.",
    "launch.commerce.title": "Commerce ready",
    "launch.commerce.body": "Selection futura con evidencia y limites.",
    "launch.assistant.title": "AI assistant",
    "launch.assistant.body": "Busqueda publica por MCP y guardrails.",
    "launch.models.title": "Model surface",
    "launch.models.body": "llms.txt, AI index y mapa de contexto.",
    "console.title": "Sistema preparado",
    "console.visual": "Visual IP",
    "console.social": "Social rails",
  ...
  en: {
    ...
    "hero.kicker": "AI-first platform - Research for Human Performance",
    "hero.copy": "A premium platform prepared for visuals, social channels, future ecommerce and an AI assistant without noise or miracle claims.",
    "launch.social.title": "Social engine",
    "launch.social.body": "Clips, trailers, newsletter and community.",
    "launch.commerce.title": "Commerce ready",
    "launch.commerce.body": "Future Selection with evidence and limits.",
    "launch.assistant.title": "AI assistant",
    "launch.assistant.body": "Public MCP search and guardrails.",
    "launch.models.title": "Model surface",
    "launch.models.body": "llms.txt, AI index and context map.",
