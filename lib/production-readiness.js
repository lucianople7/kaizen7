...
function checkProductionReadiness(options = {}) {
  ...
  if (exists(root, "package.json")) {
    ...
    for (const script of ["check", "k7:init", "k7:setup", "k7:super", "k7:brain", "k7:activate", "k7:cockpit", "k7:eval", "k7:agent", "k7:advise", "k7:codex", "k7:real", "k7:connect", "k7:onboard", "k7:improve", "k7:adapt", "k7:openhands", "k7:toolchain", "k7:openai", "k7:models", "k7:run", "k7:hunter", "k7:frontier", "k7:frontier:brief", "k7:github", "k7:hf", "k7:signal"]) {
