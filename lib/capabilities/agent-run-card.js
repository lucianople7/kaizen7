...
function closureEvidence(workbench = {}) {
  return unique([
    "changed_surface",
    "verification_result",
    "remaining_risks",
    ...(workbench.next_best_action?.inputs_needed || []),
  ]);
}
...
function buildAgentRunCard(objective = "", options = {}) {
  ...
  return {
    ...
    evidence: closureEvidence(workbench),
    evidence_detail: workbench.evidence_required,
