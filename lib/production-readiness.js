...
function checkProductionReadiness(options = {}) {
  ...
  if (exists(root, "server.js")) {
    ...
    for (const [id, endpoint] of [["k7-run", "/api/k7/run"], ["k7-advise", "/api/k7/advise"], ["k7-adapters-plan", "/api/k7/adapters/plan"], ["k7-frontier", "/api/k7/frontier"], ["k7-openai-activate", "/api/k7/openai/activate"]]) {
  ...
  if (exists(root, "package.json")) {
    ...
    for (const script of ["check", "k7:agent", "k7:advise", "k7:adapt", "k7:openai", "k7:run", "k7:hunter", "k7:frontier", "k7:frontier:brief", "k7:github", "k7:hf", "k7:signal"]) {
